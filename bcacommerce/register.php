...
<div class="flex justify-center items-center my-10">
    <form action="" method="POST" class="bg-gray-100 w-8/12 p-10 rounded shadow">
        ...
        <button type="submit" name="register" class="w-full p-2 my-5 bg-orange-500 
...
if(isset($_POST['register']))
{
    ...
    if($password==$cpassword){
        ...
        $qry = "INSERT INTO  users(fullname,email,phone,address, password) VALUES 
...
if($result){
    ...
    echo "<script> alert('password and confirm password do no match');</script>";
}
