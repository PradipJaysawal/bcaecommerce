...
<body>
    ...
    <div id="msg" class="fixed right-4 top-4 bg-blue-600 text-white px-10 py-4 
    ...
    <div class="flex">
        <nav class="h-screen bg-gray-200 shadow w-56">
            <img class="bg-orange-500 p-4" src="https://icms-image.slatic.net/images/ims-web/e650d6ca-1841-4646-b0e9-4ddbf2beb731.png" alt="">
