...
?>
     ...
     <select name="category_id" id="" class="p-2 bg-gray-100 border 
        ...
        <input type="text" name="name" placeholder="Enter Product Name" class="p-2 bg-gray-100 border 
        rounded w-full block my-3">

        <input type="text" name="description" placeholder="Enter Description" class="p-2 bg-gray-100 border 
        rounded w-full block my-3">

        <input type="text" name="price" placeholder="Enter Price" class="p-2 bg-gray-100 border 
        rounded w-full block my-3">

        <input type="text" name="stock" placeholder="Enter Stock" class="p-2 bg-gray-100 border 
        rounded w-full block my-3">
        ...
        <div class="flex justify-center gap-5 mt-5">
            <input type="submit" name="store" value="Add Product" class="bg-blue-500 text-white px-4
