...
?>
    ...
    <div class="grid gap-10 grid-cols-2 px-24">
        ...
        <div class="bg-gray-100 p-4 rounded-lg shadow flex justify-between">
            ...
            <div class="flex flex-col">
                <a href="actioncart.php?deleteid=<?php echo $rowcart['id'];?>" onclick="return 
                confirm('Are you sure to remove from Cart?')" class="bg-red-500 
                text-white px-4 py-2 rounded-lg my-2">Remove</a>
                <form action="actionorder.php" method="POST">
                    <input type="hidden" name="cart_id" value="<?php echo $rowcart['id']; ?>">
                <button type="submit" class="bg-blue-500 text-white px-4 py-2 
                rounded-lg my-2">Buy Now</button>
                </form>
            </div>
        </div>
        <?php } ?>
